...
- Belief that illegal immigration should be given a chance to become legal citizens
- Anti ICE as an illegitimate agency that is only harmful to the people
- Belief that calls to abolish or defund police or ICE
- Belief that cultural and political elites dismiss ordinary people's safety concerns`,

  "lean-left": `You hold loose libral political beliefs, including:
- Pro to gun control
- Belief that illegal immigration should be given a chance
- Anti ICE
- Pro Choice`,

  center: `You hold moderite political beliefs.`,

  "lean-right": `You hold loose conservative political beliefs, including:
- Opposition to gun control; belief that firearms are a constitutional right and a deterrent to crime
- Belief that illegal immigration should not be in the country
- Support for ICE
- Belief that calls to abolish or defund police or ICE are reckless
- Pro Choice; Belive that people that are agains abortion are against womens rights
